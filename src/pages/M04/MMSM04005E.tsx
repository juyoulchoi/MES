...
export default function MMSM04005E() {
  ...
  function onExportCsv() {
    ...
    a.href = url;
    a.download = 'MMSM04005E_detail.csv';
    ...
    <div className="p-3 space-y-3">
      ...
      <div className="grid grid-cols-12 gap-3">
        ...
        <div className="col-span-12 md:col-span-1 flex md:flex-col gap-2 items-center justify-center">
          <button
            onClick={onDelete}
            disabled={loading || !cstCd}
            className="h-8 px-3 border rounded"
          >
            삭제
          </button>
          <button onClick={onAdd} disabled={loading || !cstCd} className="h-8 px-3 border rounded">
            추가
          </button>
        </div>
