      ...
      <div className="flex flex-wrap items-end gap-3">
        <label className="flex flex-col text-sm">
          ...
          <input
            ...
            value={cstGb}
            onChange={(e) => setCstGb(e.target.value)}
            placeholder="예: Customer/Supplier"
          />
        </label>
        <label className="flex flex-col text-sm">
          ...
          <tbody>
            {rows.map((r, i) => (
              <tr key={i} className="border-b hover:bg-muted/30">
                ...
                <td className="p-1">
                  <input
                    className={`h-8 border rounded px-2 w-full ${!r.CST_NM ? 'border-destructive' : ''}`}
                    value={r.CST_NM ?? ''}
                    onChange={(e) => patch(i, { CST_NM: e.target.value })}
                  />
                </td>
                <td className="p-1">
                  <input
                    ...
                    value={r.REG_NO ?? ''}
                    onChange={(e) => patch(i, { REG_NO: e.target.value })}
                  />
                </td>
                <td className="p-1 text-center">
                  <input
                    className="h-8 border rounded px-2 w-full"
                    value={r.CST_GB ?? ''}
                    onChange={(e) => patch(i, { CST_GB: e.target.value })}
                  />
                </td>
                <td className="p-1">
                  <input
                    className="h-8 border rounded px-2 w-full"
                    value={r.CEO_NM ?? ''}
                    onChange={(e) => patch(i, { CEO_NM: e.target.value })}
                  />
                </td>
                <td className="p-1">
                  <input
                    className="h-8 border rounded px-2 w-full"
                    value={r.MGR_NM ?? ''}
                    onChange={(e) => patch(i, { MGR_NM: e.target.value })}
                  />
                </td>
                <td className="p-1">
                  <input
                    className="h-8 border rounded px-2 w-full"
                    value={r.MGR_TEL ?? ''}
                    onChange={(e) => patch(i, { MGR_TEL: e.target.value })}
                  />
                </td>
                <td className="p-1">
                  <input
                    className="h-8 border rounded px-2 w-full"
                    value={r.TEL_NO ?? ''}
                    onChange={(e) => patch(i, { TEL_NO: e.target.value })}
                  />
                </td>
                <td className="p-1">
                  <input
                    className="h-8 border rounded px-2 w-full"
                    value={r.FAX_NO ?? ''}
                    onChange={(e) => patch(i, { FAX_NO: e.target.value })}
                  />
                </td>
                <td className="p-1">
                  <input
                ...
                <td className="p-1">
                  <input
                    className="h-8 border rounded px-2 w-full"
                    value={r.POST_NO ?? ''}
                    onChange={(e) => patch(i, { POST_NO: e.target.value })}
                  />
                </td>
                <td className="p-1">
                  <input
                    className="h-8 border rounded px-2 w-full"
                    value={r.ADDR ?? ''}
                    onChange={(e) => patch(i, { ADDR: e.target.value })}
                  />
                </td>
                <td className="p-1 text-center">
                  <select
            ...
            {rows.length === 0 && (
              <tr>
                <td colSpan={15} className="p-3 text-center text-muted-foreground">
